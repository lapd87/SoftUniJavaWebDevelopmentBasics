package employees.repository.util;
...
import static employees.constants.Constants.CACHE_IGNORE;
import static employees.constants.Constants.CACHE_MODE;
...
public class EntityDeleter {
    ...
    public static <T> void deleteEntityByParameter(String parameterValue,
