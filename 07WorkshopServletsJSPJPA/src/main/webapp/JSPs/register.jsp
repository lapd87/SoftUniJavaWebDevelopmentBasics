        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="form-holder text-center">
                    <form class="form-inline" action="<%=REGISTER_URL%>" method="<%=METHOD_POST%>">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="password" id="confirmPassword" name="<%=PARAMETER_REPEAT_PASS%>"
                                           placeholder="" class="input-xlarge" required>
                                </div>
                            </div>
                            <br/>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" id="email" name="<%=PARAMETER_EMAIL%>"
                                           placeholder="" class="input-xlarge" required minlength="5">
                                </div>
                            </div>
                            <br/>
                            <div class="control-group">
